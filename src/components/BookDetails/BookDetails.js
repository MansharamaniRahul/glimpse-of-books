          ...
          {BooksStore.selectedBookDesc && (
            <div>
              <div className={styles.img}>
                <img
                  src={
                    BooksStore.selectedBookDesc.GoodreadsResponse.book.image_url
                      ._text
                  }
                />
              </div>
              ...
              <div className={styles.bookDescContainer}>
                <div className={styles.bookName}>
                  {
                    BooksStore.selectedBookDesc.GoodreadsResponse.book.title
                      ._text
                  }
                </div>
                ...
                <div className={styles.bookAuthor}>
                  by :
                  {
                    BooksStore.selectedBookDesc.GoodreadsResponse.book.authors
                      .author.name._text
                  }
                </div>
                ...
                <div className={styles.rating}>
                  {
                    BooksStore.selectedBookDesc.GoodreadsResponse.book
